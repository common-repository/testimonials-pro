...
<div class="wrap">
  <?php
	...
	if($AC <> "DEL" and trim($_POST['TP_name']) <>"")
    {
    ...
    if($AC=="DEL" && $DID > 0)
    {
		...
		echo '<span style="color:darkRed">Testimonial deleted.</span> <a href="options-general.php?page=testimonials-pro/testimonials-pro.php">Go back</a><br>';
    }
...
<?php if($DID==''){ ?>
 <p style="color:#666"> Useful information: You can add the testimonials to your site both as a widget in Appearance>Widgets or as a shortcode on your posts and pages (full testimonials). Just insert [testimonials-pro] anywhere you would like the testimonials to appear.</p>
	...
	if ( empty($data) ) 
	{ 
		echo "<div id='message' class='error'>No testimonials found!</div>";
  ...
  <iframe style="float:right; height:510px;width:400px;" scrolling="no" frameborder="0" src="http://freelance-gur.us/ads/index.php?p=tp" ></iframe>
  <form name="TP_form" method="post" action="<?php echo $mainurl; ?>" onsubmit="return TP_submit()" style="width:665px;" >
    <table width="100%">
          <tr>
...
<div class="fb-like" data-href="http://www.facebook.com/FreelanceGurus" data-send="false" data-width="450" data-show-faces="false"></div> 
  </div>
  <?php } ?>
</div>
<?php
